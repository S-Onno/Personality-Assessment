...
const resultsData = [
    ...
    // オンプレミスタイプ
    {
        ...
        // 相性
        matchType: ['<strong>ファイアウォールタイプ<br>(セキュリティ)</strong><br>安心と安全が倍増する鉄壁のタッグ','<br>','どちらもリスクを徹底的に嫌うので、お互いの慎重さを尊敬し合い、安心して自分の仕事に集中できます。'],
        // 説明文
        gaiyou: ['オンプレミス'],
    },
    ...
    // クラウドタイプ
    {
        ...
        matchType: ['<strong>光ファイバータイプ<br>(ネットワーク)</strong><br>楽しさと行動力が暴走するコンビ','<br>','新しい場所や流行を追いかけるのが好き同士。光ファイバーの勢いに乗り、クラウドはどんどん世界を広げていけます。'],
        gaiyou: ['クラウド'],
    },
    ...
    // ハイブリッドタイプ
    {
        ...
        matchType: ['<strong>スイッチタイプ<br>(ネットワーク)</strong><br>ギスギスしない理想のチームメーカー','<br>','ハイブリッドが「バランス」を作り、スイッチが「みんなを繋ぐ」。人間関係のストレスがほぼゼロになる最高の組み合わせです。'],
        gaiyou: ['ハイブリッド'],
    },
    ...
    // フロントエンドタイプ
    {
        ...
        strengths: ['見た目に強くこだわり、常に美しさや使いやすさを追求する','目標を立てたらすぐに行動し、最後までやり遂げる意志の強さ'],
        weaknesses: ['目に見える華やかな成果を優先し、地道で基礎的な土台作りを軽視しがち', '結果を急ぎすぎて、人の意見を遮ってしまうことがある'],
        matchType: ['<strong>ルータータイプ<br>(ネットワーク)</strong><br>目標達成への最速チートコード','<br>','リーダーが「目標」を宣言すれば、ルーターが感情抜きの最短ルートを瞬時に計算。無駄なくゴールに一直線です。'],
        gaiyou: ['フロントエンド'],
    },
    ...
    // バックエンドタイプ
    {
        ...
        matchType: ['<strong>ファイアウォールタイプ<br>(セキュリティ)</strong><br>組織の土台を静かに守る盟友','<br>','どちらも「目立つことより安定」を重視。互いの地味な努力を心から理解し合い、揺るぎない安心感を生み出します。'],
        gaiyou: ['バックエンド'],
    },
    ...
    // フルスタックタイプ
    {
        ...
        matchType: ['<strong>ハイブリッドタイプ<br>(インフラ)</strong><br>知識と配慮を兼ね備えたパーフェクト回答','<br>','フルスタックの「全知全能」に、ハイブリッドの「周りの気持ちを汲む力」が加わり、誰もが納得する完璧な解決策を生み出します。'],
        gaiyou: ['フルスタック'],
    },
    ...
    // ファイアウォールタイプ
    {
        ...
        matchType: ['<strong>バックエンドタイプ<br>(エンジニア型)</strong><br>組織を守り抜く最高のディフェンスライン','<br>','ファイアウォールが外敵をブロックし、バックエンドが内部の機能を完璧に維持。守りの理想的な分担ができます。'],
        gaiyou: ['ファイアウォール'],
    },
    ...
    // マルウェアタイプ
    {
        ...
        matchType: ['<strong>フロントエンドタイプ<br>(エンジニア)</strong><br>手段を選ばず結果を出す最強タッグ','<br>','策略家が「勝てる戦略（裏技含む）」を見つけ、リーダーが「それを実行する圧倒的な力」で実現します。'],
        gaiyou: ['マルウェア'],
    },
    ...
    // ゼロトラストタイプ
    {
        ...
        matchType: ['<strong>ルータータイプ<br>(ネットワーク)</strong><br>人間的なミスゼロの合理性','<br>','ゼロトラストの「客観的な評価」とルーターの「論理的な判断」が合体し、感情を完全に排除した最善手を選び続けます。'],
        gaiyou: ['ゼロトラスト'],
    },
    ...
    // ルータタイプ
    {
        ...
        matchType: ['<strong>ゼロトラストタイプ<br>(セキュリティ)</strong><br>無駄という概念が消滅する','<br>','ルーターの「最短経路」に、ゼロトラストの「疑いの目」が加わることで、非効率なプロセスは一切許されません。'],
        gaiyou: ['ルーター'],
    },
    ...
    // 光ファイバータイプ
    {
        ...
        strengths: ['情報の伝達と反応が極めて速く、即座に行動に移せる','明るい情熱で周囲のチームメンバーのモチベーションを高める'],
        weaknesses:  ['繊細で精神的な負荷に弱く、ストレスが溜まりやすい','情報を正確に扱うことにこだわり過ぎて、融通が利かない場面もある'],
        matchType: ['<strong>クラウドタイプ<br>(インフラ)</strong><br>新しいトレンドの拡散エンジン','<br>','どちらも「楽しさ」と「活動」が好き。光ファイバーの明るい勢いで、クラウドが持ち込む新しいアイデアや情報を瞬時に広めます。'],
        gaiyou: ['光ファイバー'],
    },
    ...
    // スイッチタイプ
    {
        ...
        matchType: ['<strong>ハイブリッドタイプ<br>(インフラ)</strong><br>常に平和で円満な環境が完成','<br>','違いを埋めたいハイブリッドと、みんなを繋ぎたいスイッチは、お互いの得意技を活かし合って、いつも快適な人間関係を作り出します。'],
        gaiyou: ['スイッチ'],
    },
];
